...
A system that triggers automated, localized WhatsApp or SMS alerts to patient based on their instructions.
...
The model also finds error when the giving number is wrong.
